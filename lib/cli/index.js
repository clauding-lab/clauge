...
// TWO layouts (v1.3.4 artifact-smoke lesson, 2026-07-18): in the repo,
// package.json sits two levels up from lib/cli/; in the SEA bundle,
// esbuild inlines this file into server.bundle.mjs, __dirname becomes the
// extraction dir, and the bootstrap extracts package.json BESIDE the
// bundle — so ../../ walks OUT of the sandbox and ENOENTs. Try both,
// never throw (mirror server.js's APP_VERSION fallback).
